...
ScrollReveal().reveal('.encabezado__titulo', { delay: 300 });
ScrollReveal().reveal('.encabezado__filtrar', { delay: 600 });
ScrollReveal().reveal('.encabezado__filtro', { delay: 600 });



var imagenProd = document.querySelectorAll('.tienda__producto');

function recorrerProds (boton){

  function onHoverOver(e) {
    TweenMax.fromTo(boton, 0.6, { boxShadow: '0px 0px 0px 0px #ff2221' }, { boxShadow: '0px 0px 20px 2px #a50201', repeat: -1, yoyo: true });
  }
  
  function onHoverOut(e) {
    TweenMax.to(boton, 0.2, { boxShadow: '0px 0px 0px 0px #ff2221' });
  }

  boton.addEventListener('mouseover', onHoverOver);
  boton.addEventListener('mouseout', onHoverOut);  

}

if(imagenProd != null){
  imagenProd.forEach(recorrerProds);
}
